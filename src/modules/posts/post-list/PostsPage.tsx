    ...
    return (
        <div className="min-h-screen bg-background">
            <div className="container mx-auto px-4 py-8">
                <PostListHeader onPostSave={handleAddPost} />
                ...
                {filteredPosts.length > 0 ? (
                    ...
                    <NoPostFoundBanner onClearFilter={() => {
                        setSearchTerm("")
...
function PostListHeader({ onPostSave }: PostListHeaderProps) {
...
function PostFilter({ searchTerm, sortBy, categories, selectedCategory, selectedAuthor, authors, onSearchChange, onAuthorChange, onCategoryChange, onSortChange } :PostFilterProps) {
